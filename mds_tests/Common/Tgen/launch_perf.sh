...
tgen_mas -s10 -p302 $common_args -U1
\rm tgen.*
tgen_mas -s8 -p302 $common_args -U0 -T$timeout
# MIXTE 80/20:
tick_progress "80% search / 20% modify" _mix8020
tgen_mas -t7 -p300 $common_args -U0 -T$timeout
cd ..
