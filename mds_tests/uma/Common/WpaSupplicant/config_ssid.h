...
struct wpa_ssid {
	 ...
	 * always be configured when using EAP-TLS/TTLS/PEAP.
	 *
	 ...
	 * in theory be used with EAP-TTLS and EAP-PEAP, too.
	 *
	 * Alternatively, a named configuration blob can be used by setting
	 * this to blob://<blob name>.
	 */
	 ...
	 * from the PKCS#12 file in this case.
	 *
...
#define MAX_WEP_KEY_LEN 16
	 ...
	 * updates to it when PAC is being provisioned or refreshed.
	 * Alternatively, a named configuration blob can be used by setting
	 * this to blob://<blob name>.
	 */
	char *pac_file;
	 ...
	 */
	int disabled;
    /* CC 04/2006 add State in Access Request */
    /**
     * State attribute to be set in EAP-response/Identity
    **/
    char *state;
    /* CC 07/05/2006 add EAP-Sim-Sresx and EAP-Sim-KCx */
    char *EAPSimSres1;
    char *EAPSimSres2;
    char *EAPSimSres3;
    char *EAPSimKC1;
    ...
    char *EAPSimKC3;
      ...
      */
    char * servicetype;
    char * wimaxcapability;
    char * session_termination_capability;
    char * ppac;
