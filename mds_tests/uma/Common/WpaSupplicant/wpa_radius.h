/**
 * HISTORY:
 *     2007/12/04 | ZTX | Add new radius attribute declaration: RADIUS_ATTR_FRAMED_IP_ADDRESS
 *     Aug 26,2008 | RHL | Add new radius attribute declaration: RADIUS_ATTR_SERVICE_TYPE,  RADIUS_VENDOR_ID_WIMAX,
 *
 */
#ifndef RADIUS_H
#define RADIUS_H
...
enum { RADIUS_ATTR_USER_NAME = 1,
       ...
       // Aug 26,2008 | RHL | Add new radius attribute declaration: RADIUS_ATTR_SERVICE_TYPE
       RADIUS_ATTR_SERVICE_TYPE = 6,
       // 2007/12/04 | ZTX | BEGIN | Add new radius attribute declaration: RADIUS_ATTR_FRAMED_IP_ADDRESS
       RADIUS_ATTR_FRAMED_IP_ADDRESS = 8,
       // 2007/12/04 | ZTX | END | Add new radius attribute declaration: RADIUS_ATTR_FRAMED_IP_ADDRESS
...
enum {  RADIUS_VENDOR_ATTR_WIMAX_CAPABILITY = 1,
	RADIUS_VENDOR_ATTR_AAA_SESSION_ID = 4,
	RADIUS_VENDOR_ATTR_SESSION_CONTINUE = 21,
	RADIUS_VENDOR_ATTR_BEGINNING_OF_SESSION = 22,
	RADIUS_VENDOR_ATTR_HOTLINE_INDICATION = 24,
	RADIUS_VENDOR_ATTR_PREPAID_INDICATOR = 25, 
	RADIUS_VENDOR_ATTR_PDFID = 26,
	RADIUS_VENDOR_ATTR_SDFID = 27,
	RADIUS_VENDOR_ATTR_PPAC = 35,
	RADIUS_VENDOR_ATTR_SESSION_TERMINATION_CAPABILITY = 36,
	RADIUS_VENDOR_ATTR_PPAQ = 37
};
...
//RHL, put it as public method
u8 *radius_msg_get_wimax_vsa(struct radius_msg *msg, u32 vendor,
