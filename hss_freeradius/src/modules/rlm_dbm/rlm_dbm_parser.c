 ...
 *
 * Version:     $Id: rlm_dbm_parser.c,v 1.8 2003/09/11 12:48:25 phampson Exp $
 *
...
char sccsid[] =
"$Id: rlm_dbm_parser.c,v 1.8 2003/09/11 12:48:25 phampson Exp $ sandy module project\n Copyright 2001 Sandy Service\nCopyright 2001 Koulik Andrei";
	...
	while ((ch = getopt(n, argv, "d:i:xo:qvc")) != -1) 
	 	switch (ch) {
			...
			case 'q':
				...
				break;
			case 'v':
				printf("%s: $Id: rlm_dbm_parser.c,v 1.8 2003/09/11 12:48:25 phampson Exp $ \n",progname);
				exit(0);
			case 'c':
