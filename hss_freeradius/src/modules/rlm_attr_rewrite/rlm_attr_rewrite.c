 ...
 * rlm_attr_rewrite.c
 *
 * Version:  $Id: rlm_attr_rewrite.c,v 1.13 2003/09/03 15:19:31 cparker Exp $
 *
...
static const char rcsid[] = "$Id: rlm_attr_rewrite.c,v 1.13 2003/09/03 15:19:31 cparker Exp $";
