 ...
 *
 * Version:	$Id: radius.c,v 1.45 2001/03/12 16:48:14 aland Exp $
 *
 */

static const char rcsid[] = "$Id: radius.c,v 1.45 2001/03/12 16:48:14 aland Exp $";
...
int rad_send(RADIUS_PACKET *packet, const char *secret)
{
	...
	if (!packet->data) {
		  ...
		  printf("Creating a radius packet with a wrong length.\n");
		  packet->data_len = 1;
